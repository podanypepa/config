...
vim.keymap.set("n", "<leader>aa", ":Neotree toggle reveal<CR>", { desc = "File History" })
vim.keymap.set("n", "<leader>as", ":Neotree toggle git_status reveal<CR>", { desc = "File History" })
vim.keymap.set("n", "<leader>ab", ":Neotree toggle buffers reveal<CR>", { desc = "File History" })
